...
if ( $#argv != 1 ) then
   echo "Usage: $0 srcdatasets"
   exit 100
endif

set MODEL=/home/alta/BLTSpeaking/ged-pm574/clctraining-v3/lib/models/clctraining-v3.tlc.model
set DEVNULL=/home/alta/BLTSpeaking/ged-pm574/gec-lm/tmp/devnull.txt
set OUTPUT=/home/alta/BLTSpeaking/ged-pm574/gec-lm/tmp/tmp2.txt
set SRC=$1
...
$PYTHONBIN /home/alta/BLTSpeaking/ged-pm574/local/sequence-labeler/print_output.py probs $MODEL $SRC 2> $OUTPUT
